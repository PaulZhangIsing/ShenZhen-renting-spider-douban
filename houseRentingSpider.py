    ...
    def run(self):
        ...
        try:
            ...
            def urlList(page_number):
                ...
                douban_url = ['https://www.douban.com/group/search?start=' + num_in_url +'&group=106955&cat=1013&sort=time&q=']
                return douban_url
            douban_url_name = [u'深圳租房']
            ...
            with file:
                file.write('''<html>
                    ...
                    <title>深圳租房信息 | 豆瓣 | Author: Paul Zhang @ Panasonic R&D SG</title>
                    <link rel="stylesheet" type="text/css" href="../lib/resultPage.css">
                    </head>
                    <body>''')
                file.write('<h1>SHENZHEN Renting Information 深圳租房信息 | </h1>')
                file.write('''
